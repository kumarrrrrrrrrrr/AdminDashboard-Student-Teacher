...
export default function Teachersedit(props){
    ...
    useEffect( async()=>{
        let data = await fetch(`https://6309b19ff8a20183f7756402.mockapi.io/teacher/${props.match.params.id}`);
    ...
    const formik =  useFormik({
      ...
      onSubmit: async (values) => {
        ...
        await fetch(`https://6309b19ff8a20183f7756402.mockapi.io/teacher/${props.match.params.id}`,{
        method: "PUT",
        body: JSON.stringify({
          Name,
          Emailid,
